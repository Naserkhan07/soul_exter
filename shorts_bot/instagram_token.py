...
def exchange_long_lived_page_token(
    ...
    for page in pages:
        ...
        return page_token, str(page.get("name") or "Unnamed Page")
...
def main() -> None:
    ...
    try:
        page_token, page_name = exchange_long_lived_page_token(
            app_id,
            app_secret,
            user_token,
            args.username,
    ...
    print(f"Saved a long-lived Page token for @{args.username} ({page_name}) to {args.env_file}.")
